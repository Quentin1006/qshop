...
let BasketController = class BasketController {
    ...
    getBasket(basketId, create) {
        return this.basketService.getBasket(basketId, { create });
    }
    countBasketItems(basketId) {
        return this.basketService.countBasketItems(+basketId);
    }
};
__decorate([
    (0, common_1.Get)(':basketId'),
    __param(0, (0, common_1.Param)('basketId')),
    __param(1, (0, common_1.Query)('create')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Boolean]),
    __metadata("design:returntype", void 0)
], BasketController.prototype, "getBasket", null);
__decorate([
    (0, common_1.Get)(':basketId/count'),
    __param(0, (0, common_1.Param)('basketId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], BasketController.prototype, "countBasketItems", null);
